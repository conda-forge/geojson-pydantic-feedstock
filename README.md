...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/geojson-pydantic-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/geojson-pydantic-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add geojson-pydantic
# for installing globally
pixi global install geojson-pydantic
```
...
It is possible to list all of the versions of `geojson-pydantic` available on your platform:
...
```
pixi search geojson-pydantic --channel conda-forge
```
